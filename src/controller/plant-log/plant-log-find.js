...
PlantLogFind.TABLE = CONSTANTS.TABLE_PLANT_LOG;
...
PlantLogFind.DEFAULT_FIELDS = [
    CONSTANTS.TABLE_PLANT_LOG + '.' + CONSTANTS.ATTR_ID_PLANT_LOG,
    CONSTANTS.TABLE_PLANT_LOG + '.' +  CONSTANTS.ATTR_TIMESTAMP_PLANT_LOG
];
