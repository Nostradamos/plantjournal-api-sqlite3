...
module.exports =  async function createTables() {
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${CONSTANTS.TABLE_ENVIRONMENT} (
      ...
      environmentAddedAt DATETIME NOT NULL,
  ...
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${CONSTANTS.TABLE_MEDIUM} (
      ...
      mediumAddedAt DATETIME NOT NULL,
  ...
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${CONSTANTS.TABLE_FAMILY} (
      ...
      familyAddedAt DATETIME NOT NULL,
  ...
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${ CONSTANTS.TABLE_GENERATION} (
      ...
      generationAddedAt DATETIME NOT NULL,
  ...
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${CONSTANTS.TABLE_GENOTYPE} (
      ...
      genotypeAddedAt DATETIME NOT NULL,
  ...
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${CONSTANTS.TABLE_PLANT} (
      ...
      plantAddedAt DATETIME NOT NULL,
  ...
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${CONSTANTS.TABLE_JOURNAL} (
      ...
      journalAddedAt DATETIME NOT NULL,
  ...
  await sqlite.run(`
    CREATE TABLE IF NOT EXISTS ${CONSTANTS.TABLE_ATTACHMENT} (
      ...
      ${CONSTANTS.ATTR_ADDED_AT_ATTACHMENT} DATETIME NOT NULL,
      ${CONSTANTS.ATTR_MODIFIED_AT_ATTACHMENT} DATETIME NOT NULL,
      PRIMARY KEY (${CONSTANTS.ATTR_ID_ATTACHMENT})
    );
  `);
};
