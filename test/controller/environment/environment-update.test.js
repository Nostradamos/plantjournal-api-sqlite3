...
describe('Environment()', function() {
    describe('#update()', function() {
        ...
        it('should update environment in database and return updated environment id', async function() {
            let updated = await pj.Environment.update({'environmentName': 'testEnvironment2'}, {filter: {environmentId: 2}});
