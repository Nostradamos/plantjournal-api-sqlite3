...
describe('TranslateOperatorsJournalValue', () => {
    describe('Operators', () => {
        ...
        describe('#operatorGreatherThan()', () => {
            it('should do TABLE.ATTR > OPERATOROPTIONS if self.func and self.funcArgs are null', () => {
                TranslateOperatorsJournalValue.operatorGreatherThan(self, 13, crit);
                crit.should.eql(
        ...
        describe('#operatorGreatherThanEqual()', () => {
            it('should do TABLE.ATTR >= OPERATOROPTIONS if self.func and self.funcArgs are null', () => {
                TranslateOperatorsJournalValue.operatorGreatherThanEqual(self, 13, crit);
                crit.should.eql(
                    {crit: '?.? >= ?', args: [self.table, self.attr, 13]});
            });
        ...
        describe('#operatorLowerThan()', () => {
            it('should do TABLE.ATTR < OPERATOROPTIONS if self.func and self.funcArgs are null', () => {
                TranslateOperatorsJournalValue.operatorLowerThan(self, 13, crit);
                crit.should.eql(
                    {crit: '?.? < ?', args: [self.table, self.attr, 13]});
            });
        ...
        describe('#operatorLowerThanEqual()', () => {
            it('should do TABLE.ATTR <= OPERATOROPTIONS if self.func and self.funcArgs are null', () => {
                TranslateOperatorsJournalValue.operatorLowerThanEqual(self, 13, crit);
                crit.should.eql(
                    {crit: '?.? <= ?', args: [self.table, self.attr, 13]});
            });
        ...
        describe('#operatorLike()', () => {
            it('should do TABLE.ATTR LIKE OPERATOROPTIONS if self.func and self.funcArgs are null', () => {
                TranslateOperatorsJournalValue.operatorLike(self, '_est', crit);
                crit.should.eql(
