...
// CONSTANTS
const allowedFields = _.concat(CONSTANTS.FIELDS_FAMILY, CONSTANTS.FIELDS_GENERATION, CONSTANTS.FIELDS_GENOTYPE, CONSTANTS.FIELDS_PLANT);
const fieldAliases = _.merge({}, CONSTANTS.FIELD_ALIASES_FAMILY, CONSTANTS.FIELD_ALIASES_GENERATION, CONSTANTS.FIELD_ALIASES_GENOTYPE, CONSTANTS.FIELD_ALIASES_PLANT);
