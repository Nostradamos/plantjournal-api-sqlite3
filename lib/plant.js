...
const validateFields = [
  ['plantName', 'string', true],
  ['plantClonedFrom', 'int', false],
  ['generationId', 'int', false],
...
Plant.create = async function create(options) {
  ...
  let q = squel
    .insert()
    .into(Constants.tablePlants)
    .set('plantId', null)
    .set('plantName', plantName)
    .set('plantClonedFrom', plantClonedFrom)
    .set('plantSex', plantSex)
    .set('genotypeId', genotypeId)
    .toString();
