...
const allowedFields = _.concat(CONSTANTS.FIELDS_FAMILY, CONSTANTS.FIELDS_GENERATION);
const fieldAliases = _.merge({}, CONSTANTS.FIELD_ALIASES_FAMILY, CONSTANTS.FIELD_ALIASES_GENERATION);
